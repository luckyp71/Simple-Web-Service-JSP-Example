 ...
 * generated in the com.lucky package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://lucky.com/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://lucky.com/", "addResponse");
    private final static QName _Divide_QNAME = new QName("http://lucky.com/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://lucky.com/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://lucky.com/", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://lucky.com/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://lucky.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://lucky.com/", "subtractResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.lucky
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://lucky.com/", name = "subtractResponse")
