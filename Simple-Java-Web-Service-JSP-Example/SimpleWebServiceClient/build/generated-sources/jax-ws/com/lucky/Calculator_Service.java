 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://lucky.com/", wsdlLocation = "http://localhost:8080/SimpleWebService/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://lucky.com/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SimpleWebService/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://lucky.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://lucky.com/", "CalculatorPort"), Calculator.class, features);
    }
